        ...
        public static void groupShiftedString(String str[], int n){
            ...
            for (int i = 0; i < n; i++){
                ...
                if(groupMap.get(diffStr) != null){
                    System.out.println(groupMap.get(diffStr));
           ...
           /* Iterator it = groupMap.entrySet().iterator();
            ...
            for(Map.Entry<String , Vector<Integer>> pair : groupMap.entrySet()){
                Vector<Integer> v = pair.getValue();
                for (int i= 0; i< v.size(); i++){
                    System.out.print(str[v.get(i)] + " ");
                }
                System.out.println();
